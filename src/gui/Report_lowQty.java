 ...
 * @author CODE53215
 */
public class Report_lowQty extends javax.swing.JFrame {

    /**
     * Creates new form Report_lowQty
     */
    public Report_lowQty() {
        initComponents();
        loadStock();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Report_lowQty.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Report_lowQty().setVisible(true);
            }
        });
    }

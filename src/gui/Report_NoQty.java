 ...
 * @author CODE53215
 */
public class Report_NoQty extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Zero Quantity Products");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Report_NoQty.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Report_NoQty().setVisible(true);
            }
        });
    }
